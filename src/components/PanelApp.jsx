      ...
      {objetivos.length === 0 ? <p style={{ color: '#94a3b8', textAlign: 'center', padding: 40 }}>Sin objetivos cargados.</p> : (
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 1200 }}>
            <thead><tr style={{ background: '#231F20' }}><th style={{ ...th, color: '#D4D2C6' }}>Objetivo</th><th style={{ ...th, color: '#D4D2C6' }}>Corp.</th><th style={{ ...th, color: '#D4D2C6' }}>Pond.</th><th style={{ ...th, color: '#D4D2C6' }}>Status</th><th style={{ ...th, color: '#D4D2C6' }}>Alcances</th><th style={{ ...th, color: '#D4D2C6' }}>Coment. Lider</th><th style={{ ...th, color: '#D4D2C6' }}>Accion</th></tr></thead>
...
function PanelAdminObjetivos({ profile }) {
  ...
  async function agregarObjetivoAdmin() { 
    ...
    await supabase.from('objetivos').insert({ 
      colaborador_id: colaboradorSeleccionado, objetivo: nuevoObjetivo.objetivo, corporativo: nuevoObjetivo.corporativo, ponderacion: nuevoObjetivo.ponderacion, status: 'pendiente',
      alcance_0_descripcion: nuevoObjetivo.alcance_0_descripcion || null, alcance_0_fecha: nuevoObjetivo.alcance_0_fecha || null,
      alcance_80_descripcion: nuevoObjetivo.alcance_80_descripcion || null, alcance_80_fecha: nuevoObjetivo.alcance_80_fecha || null,
      alcance_100_descripcion: nuevoObjetivo.alcance_100_descripcion || null, alcance_100_fecha: nuevoObjetivo.alcance_100_fecha || null,
      alcance_120_descripcion: nuevoObjetivo.alcance_120_descripcion || null, alcance_120_fecha: nuevoObjetivo.alcance_120_fecha || null
    ...
    setNuevoObjetivo({ objetivo: '', corporativo: '', ponderacion: 25, alcance_0_descripcion: '', alcance_0_fecha: '', alcance_80_descripcion: '', alcance_80_fecha: '', alcance_100_descripcion: '', alcance_100_fecha: '', alcance_120_descripcion: '', alcance_120_fecha: '' }); 
    setColaboradorSeleccionado(''); setMostrarForm(false); cargarDatos(); 
  }
    ...
    <div>
      ...
      {mostrarForm && (
        <div style={{ ...s.tarjetaStat, marginBottom: 20, background: '#f8fafc' }}><h4>Asignar Objetivo a Cualquier Colaborador</h4>
          ...
          <button onClick={agregarObjetivoAdmin} style={{ ...s.btnPrimario, background: '#22c55e', marginTop: 16 }}>💾 Guardar Objetivo</button>
        </div>
      )}
