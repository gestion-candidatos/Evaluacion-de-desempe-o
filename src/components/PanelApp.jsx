...
return React.createElement('div', null, React.createElement('h3', null, '👥 Mi Equipo (' + equipo.length + ')'), equipo.length === 0 ? React.createElement('p', null, 'No tienes colaboradores.') : React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 16 } }, filas));function FeedbackForm({ feedback: col, cicloId, onVolver }) {
